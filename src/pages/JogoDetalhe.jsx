      ...
      >
        ...
        {jogo.imageUrl ? (
          <div style={{
            ...
            backgroundImage: `url(${jogo.imageUrl.startsWith('http') ? jogo.imageUrl : 'https:' + jogo.imageUrl})`,
            backgroundSize: 'cover',
            backgroundPosition: 'center top',
            filter: 'blur(18px) brightness(0.35) saturate(1.2)',
            transform: 'scale(1.08)', // evita borda branca do blur
          }} />
        ) : (
          <div style={{
            position: 'absolute', inset: 0,
        ...
        {/* Overlay de gradiente sobre o blur */}
        <div style={{
          position: 'absolute', inset: 0,
          background: 'linear-gradient(to right, rgba(7,11,20,0.92) 0%, rgba(7,11,20,0.65) 60%, rgba(7,11,20,0.3) 100%)',
          pointerEvents: 'none',
        }} />
        ...
        <div style={{
          ...
          {jogo.imageUrl && (
            <div style={{
              ...
              <img
                src={jogo.imageUrl.startsWith('http') ? jogo.imageUrl : 'https:' + jogo.imageUrl}
                alt={jogo.nome}
                width={130}
                loading="eager"
                decoding="async"
